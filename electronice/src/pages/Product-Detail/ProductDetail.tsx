...
import ProductDescriptionInfo from './Infor-Product/ProductDescriptionInfo'
...
const ProductDetail: React.FC = () => {
  ...
  const [inforProducts, setInforProducts] = useState<Array<Product> | any>()
  ...
  return (
    <>
      <Helmet>{inforProducts && inforProducts.name}</Helmet>
      <BreadCrumbs title={inforProducts && inforProducts.name} />
      <div className="product-container">
        <Row style={{ margin: '50px auto' }}>
          ...
          <Col xs={24} xl={12}>
            {inforProducts && <ProductDescriptionInfo product={inforProducts} />}
          </Col>
        </Row>
